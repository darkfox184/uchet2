...
begin
  // ќтображение диалога с подтверждением
  buttonSelected := MessageDlg('¬ы действительно хотите удалить товар из заказа?',mtWarning, mbOKCancel, 0);
     // ѕоказ типа выбранной кнопки
