...
DataModule2.zakaz_Query.ParamByName('poluch').Value:='да';
...
DataModule2.redtovp_save_Query1.ParamByName('poluch').AsString:='нет';
...
DataModule2.zakaz_Query.ParamByName('poluch').AsString:='да';
DataModule2.zakaz_Query.open;
end;
...
begin
  ...
  buttonSelected := MessageDlg('Вы действительно хотите удалить товар из заказа?',mtWarning, mbOKCancel, 0);
